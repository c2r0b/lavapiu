    ...
    return (
        <Section id="priceList" type="light">
            ...
            <table className="table-fixed border-collapse mb-16 border border-gray-200 dark:border-neutral-700">
                <thead>
                    <tr>
                        <th className="w-1/2 p-3 border border-gray-200 dark:border-neutral-700">{t('service')}</th>
                        <th className="w-1/4 p-3 border border-gray-200 dark:border-neutral-700">{t('price')}</th>
                        <th className="w-1/4 p-3 border border-gray-200 dark:border-neutral-700">{t('load')}</th>
                    </tr>
                </thead>
                <tbody>
                    <tr className="bg-gray-50 dark:bg-neutral-800 border-l-4 border-lime-500">
                        <td className="p-3 border border-gray-200 dark:border-neutral-700 font-bold">{t('wash')}</td>
                    ...
                    <tr className="bg-gray-50 dark:bg-neutral-800 border-l-4 border-lime-500">
                        <td className="p-3 border border-gray-200 dark:border-neutral-700">{t('dry')}</td>
                        <td className="p-3 border border-gray-200 dark:border-neutral-700 font-bold text-lime-600">€ 5,00</td>
                    ...
                    <tr>
                        <td className="p-3 border border-gray-200 dark:border-neutral-700">{t('petWash')}</td>
                        <td className="p-3 border border-gray-200 dark:border-neutral-700">€ 4,00</td>
                        <td className="p-3 border border-gray-200 dark:border-neutral-700">6kg</td>
                    </tr>
                    <tr>
                        <td className="p-3 border border-gray-200 dark:border-neutral-700">{t('petDry')}</td>
                        <td className="p-3 border border-gray-200 dark:border-neutral-700">€ 4,00</td>
                        <td className="p-3 border border-gray-200 dark:border-neutral-700">6kg</td>
                    </tr>
                </tbody>
